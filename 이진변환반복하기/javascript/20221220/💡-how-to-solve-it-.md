...
0과 1로 이루어진 문자열 s가 주어질 때 해당 문자열을 1일 될 때까지 이진 변환을 하고 이진 변환의 횟수와 제거한 0의 갯수를 배열에 담아 반환하는 함수를 작성하라.

### 1. 이해
- 주어지는 값은 문자열이다. 문자열의 길이는 1이상 150,000이하
- 이진 변환 공식은 문자열의 모든 0 제거 -> 0이 제거된 문자열의 길이를 2진수로 전환
